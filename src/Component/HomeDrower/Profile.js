...
import UserHeader from "../../../src/sharedComponet/UserHeader"
import {
  Button,
  Card,
  CardHeader,
                    ...
                    <Row>
                      <Col lg="6">
                        <FormGroup>
                          ...
                          <TextField fullWidth label="firstname" id="fullWidth" type='text' />
                      ...
                      <Col lg="6">
                        <FormGroup>
                          ...
                          <TextField fullWidth label="Lastname" id="fullWidth" type='text' />
                    ...
                    <Row>
                      <Col md="12">
                        <FormGroup>
                          ...
                          <TextField fullWidth label="Address" id="fullWidth" type='text' 
